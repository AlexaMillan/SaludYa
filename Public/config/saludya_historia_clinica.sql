...
CREATE TABLE `historia_clinica` (
  ...
  CONSTRAINT `historia_clinica_ibfk_1` FOREIGN KEY (`idpaciente`) REFERENCES `usuario` (`idusuario`),
  CONSTRAINT `historia_clinica_ibfk_2` FOREIGN KEY (`idespecialista`) REFERENCES `especialista` (`idespecialista`)
...
-- Dump completed on 2026-06-10  6:49:43
